        ...
        <div>
            ...
            <div className="row mx-4">
                ...
                <div className="col-sm-6 col-md-4 col-lg-3 mb-4">
                    <div className="card bg-success text-light">
                        <div className="card-body pb-4">
                            <h4 className="card-title pb-1">Electrical Installation <strong>(New)</strong></h4>
                            <p className="card-text">Light fixture and electrical outlet installations. <strong>First 20 bookings discounted 20%</strong>.</p>
                        </div>
                        <ul className="list-group list-group-flush">
                                <li className="list-group-item bg-success text-light"><p className="h4 pt-3"><s className="text-dark">$52/hr</s> <strong>$42/hr</strong></p><p className="h6 pt-0"><s className="text-dark">$42/hr</s> <strong>$34/hr</strong> <font style={{fontWeight: 300}}>after first hour</font></p></li>
                                <li className="list-group-item bg-success text-light">        
                                <Link to="../Contact" className="btn btn-secondary"  state={{service: "Electrical Installation"}}>Get a Quote</Link>
                                </li>
                                <li className="list-group-item bg-success text-light pb-3">        
                                <Link to="https://jamison-rubino.bookafy.com/category/moving-help-1803b3?locale=en" className="btn btn-dark"  state={{service: "Moving Help"}} target="_blank">Book Now</Link>
                                </li>
