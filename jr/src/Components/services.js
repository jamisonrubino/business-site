                    ...
                    <div className="card bg-light text-dark border shadow-sm">
                        <div className="card-body p-4">
                            ...
                            <h6
                                ...
                                style={{
                                fontSize: "14px"
                            }}><a href="https://www.taskrabbit.com/profile/jamison-r--5?ref=TRYBX6ON&utm_medium=tryprofile&invitation_source=url&utm_source=trycode" alt="" style={{textDecoration: 'none'}} target="_blank">4.7 &#9733;&#9733;&#9733;&#9733;&#9733;&nbsp;
                            
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="#76a4d9" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M20 14a1 1 0 0 0-1 1v3.077c0 .459-.022.57-.082.684a.363.363 0 0 1-.157.157c-.113.06-.225.082-.684.082H5.923c-.459 0-.571-.022-.684-.082a.363.363 0 0 1-.157-.157c-.06-.113-.082-.225-.082-.684L4.999 5.5a.5.5 0 0 1 .5-.5l3.5.005a1 1 0 1 0 .002-2L5.501 3a2.5 2.5 0 0 0-2.502 2.5v12.577c0 .76.083 1.185.32 1.627.223.419.558.753.977.977.442.237.866.319 1.627.319h12.154c.76 0 1.185-.082 1.627-.319.419-.224.753-.558.977-.977.237-.442.319-.866.319-1.627V15a1 1 0 0 0-1-1zm-2-9.055v-.291l-.39.09A10 10 0 0 1 15.36 5H14a1 1 0 1 1 0-2l5.5.003a1.5 1.5 0 0 1 1.5 1.5V10a1 1 0 1 1-2 0V8.639c0-.757.086-1.511.256-2.249l.09-.39h-.295a10 10 0 0 1-1.411 1.775l-5.933 5.932a1 1 0 0 1-1.414-1.414l5.944-5.944A10 10 0 0 1 18 4.945z" fill="currentColor" style={{fill:"#76a4d9"}}/></svg>
                    ...
                    <div className="card bg-light text-dark border shadow-sm">
                        <div className="card-body p-4">
                            <Link
                                ...
                                className="text-dark">
                                <h4 className="card-title pb-1 mb-0">Furniture assembly&nbsp;
                                <svg width="18" height="18" viewBox="0 0 24 24" fill="#76a4d9" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" clip-rule="evenodd" d="M20 14a1 1 0 0 0-1 1v3.077c0 .459-.022.57-.082.684a.363.363 0 0 1-.157.157c-.113.06-.225.082-.684.082H5.923c-.459 0-.571-.022-.684-.082a.363.363 0 0 1-.157-.157c-.06-.113-.082-.225-.082-.684L4.999 5.5a.5.5 0 0 1 .5-.5l3.5.005a1 1 0 1 0 .002-2L5.501 3a2.5 2.5 0 0 0-2.502 2.5v12.577c0 .76.083 1.185.32 1.627.223.419.558.753.977.977.442.237.866.319 1.627.319h12.154c.76 0 1.185-.082 1.627-.319.419-.224.753-.558.977-.977.237-.442.319-.866.319-1.627V15a1 1 0 0 0-1-1zm-2-9.055v-.291l-.39.09A10 10 0 0 1 15.36 5H14a1 1 0 1 1 0-2l5.5.003a1.5 1.5 0 0 1 1.5 1.5V10a1 1 0 1 1-2 0V8.639c0-.757.086-1.511.256-2.249l.09-.39h-.295a10 10 0 0 1-1.411 1.775l-5.933 5.932a1 1 0 0 1-1.414-1.414l5.944-5.944A10 10 0 0 1 18 4.945z" fill="currentColor" style={{fill: "#212529"}}/></svg>
                                </h4>
                            </Link>
                            <h6
                                className='text-muted mb-0 pb-1'
                            ...
                            <h6
                                ...
                                <a href="https://www.taskrabbit.com/profile/jamison-r--5?ref=TRYBX6ON&utm_medium=tryprofile&invitation_source=url&utm_source=trycode" style={{textDecoration: 'none'}} alt="" target="_blank">{rating}4.9 &#9733;&#9733;&#9733;&#9733;&#9733;&nbsp;
                    ...
                    <div className="card bg-dark text-light border shadow-sm">
                        ...
                        <div className="card-body p-4">
                            ...
                            <h6
                                ...
                                <a href="https://upwork.com/freelancers/~0180302a9d35e1993e" target="_blank" style={{textDecoration: 'none', lineHeight: "18px"}} alt="">
                            ...
                            <p className="card-text">Build or improve your personal or business website with
                                ...
                                &bull;&nbsp;WordPress, Bubble.io, Adalo, Shopify<br />
                                &bull;&nbsp;Email campaign development<br />
